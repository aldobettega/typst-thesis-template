...
La seconda VM ospita Metasploitable2, una macchina Linux intenzionalmente vulnerabile, usata per condurre test per strumenti di sicurezza e praticare tecniche di #emph[#gls("pentesting")] comuni.
