...
* **2.2 Pianificazione delle attività:** Cronoprogramma settimanale dello stage con descrizione dei task affrontati e dei milestone raggiunti.
...
* **4.1 Stack Backend:** Python 3.12, framework e librerie principali (Pydantic, dataclasses).
* **4.2 Stack Frontend:** TypeScript, React.
...
* **8.2 Vincoli sulle API esterne:** Limitazioni dovute all'uso del tier gratuito dell'intelligenza artificiale (es. rate limiting) e conseguente decisione di analizzare un sottoinsieme limitato (MVP su 5 vulnerabilità) per dimostrare il proof of concept.
...
* Testi di riferimento (es. Clean Code).
